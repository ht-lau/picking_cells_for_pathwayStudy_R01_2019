...
# The expression data is already in the function 
filter.essential.genes <- function(essential.df) { 
  ...
  # use 75 percentile as the cut-off and test
  essential.gene.expression$Threshold <- apply(essential.gene.expression[, 3:1078], 
                                            1, quantile, probs = 0.75)
  test.threshold <- as.data.frame(apply(essential.gene.expression[, 3:1078, drop = FALSE],
                                     2, function(x) x > essential.gene.expression$Threshold))
