...
pathway.genes.expression <- apply(essential, 1, filter.essential.genes)
pathway.names <- sub(pattern = "Reactome.", replacement = "", x = essential$Pathway)
num.of.genes <- sapply(pathway.genes.expression, nrow)
pathway.genes.expression <- Reduce(x = pathway.genes.expression, f = function(x,y) rbind(x,y))
